    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (con != null && !con.isClosed()) {
                ...
                //------Restricting Login Attempts from the users-----------------
                } else {
                    ...
                    if (loginAttempt <= 2) {
                        ...
                        String message = "WRONG CREDENTIALS, TRY AGAIN " +"Login Attempt "+ loginAttempt;
                        response.sendRedirect("errorpage.jsp?message=" + URLEncoder.encode(message, "UTF-8"));
                    } else if (loginAttempt >= 3) {

                        String message2 = "you have reached Maximum Login Attempts,try again after sometime ";
                        response.sendRedirect("errorpage.jsp?message=" + URLEncoder.encode(message2, "UTF-8"));
                        ...
                        // applying 5 seconds hold for testing purpose  
                        if (timeDiff > 5000) {
